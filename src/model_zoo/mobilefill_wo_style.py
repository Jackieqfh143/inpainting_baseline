...
class MobileFill_WO_STYLE(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/ablations/wo_style.yaml", **kwargs):
        super(MobileFill_WO_STYLE, self).__init__(**kwargs)
        ...
        # no Labels.
        print('MobileFill_WO_STYLE loaded.')
