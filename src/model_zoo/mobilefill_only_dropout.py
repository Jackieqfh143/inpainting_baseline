...
class MobileFill_ONLY_DROPOUT(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/ablations/only_dropout.yaml", **kwargs):
        super(MobileFill_ONLY_DROPOUT, self).__init__(**kwargs)
        ...
        # no Labels.
        print('MobileFill_ONLY_DROPOUT loaded.')
