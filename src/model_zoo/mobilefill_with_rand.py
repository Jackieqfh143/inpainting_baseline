...
class MobileFill_WITH_RAND(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/ablations/with_randmask.yaml", **kwargs):
        super(MobileFill_WITH_RAND, self).__init__(**kwargs)
        ...
        # no Labels.
        print('MobileFill_WITH_RAND loaded.')
