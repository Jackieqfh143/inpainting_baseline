...
class MobileFill_ONLY_ADD(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/ablations/only_add.yaml", **kwargs):
        super(MobileFill_ONLY_ADD, self).__init__(**kwargs)
        ...
        # no Labels.
        print('MobileFill_ONLY_ADD loaded.')
