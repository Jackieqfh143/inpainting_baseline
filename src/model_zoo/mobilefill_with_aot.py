...
class MobileFill_WITH_AOT(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/ablations/with_aot_block.yaml", **kwargs):
        super(MobileFill_WITH_AOT, self).__init__(**kwargs)
        ...
        # no Labels.
        print('MobileFill_WITH_AOT loaded.')
