...
class MobileFill_WO_MOBILEVIT(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/ablations/wo_vit.yaml", **kwargs):
        super(MobileFill_WO_MOBILEVIT, self).__init__(**kwargs)
        ...
        # no Labels.
        print('MobileFill_WO_MOBILEVIT loaded.')
