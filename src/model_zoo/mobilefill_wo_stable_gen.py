...
class MobileFill_WO_STABLE_GEN(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/ablations/wo_stable_gen_block.yaml", **kwargs):
        super(MobileFill_WO_STABLE_GEN, self).__init__(**kwargs)
        ...
        # no Labels.
        print('MobileFill_WO_STABLE_GEN loaded.')
