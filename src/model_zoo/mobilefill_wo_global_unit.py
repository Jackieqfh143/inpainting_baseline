...
class MobileFill_WO_GLOBAL_UNIT(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/ablations/wo_global_unit.yaml", **kwargs):
        super(MobileFill_WO_GLOBAL_UNIT, self).__init__(**kwargs)
        ...
        self.one_for_holes = False

        # no Labels.
        print('MobileFill_WO_GLOBAL_UNIT loaded.')
