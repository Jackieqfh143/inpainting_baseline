...
class MobileFill_WITH_COMOD(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/ablations/with_comod_style.yaml", **kwargs):
        super(MobileFill_WITH_COMOD, self).__init__(**kwargs)
        ...
        # no Labels.
        print('MobileFill_WITH_COMOD loaded.')
