...
class MobileFill_WO_AUG_GEN_BLOCK(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/ablations/wo_aug_gen_block.yaml", **kwargs):
        super(MobileFill_WO_AUG_GEN_BLOCK, self).__init__(**kwargs)
        ...
        # no Labels.
        print('MobileFill_WO_AUG_GEN_BLOCK loaded.')
