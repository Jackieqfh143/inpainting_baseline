import torch
from src.lib.EFill.modules.EFill_wo_kt_and_ks import DistInpaintModel_SPADE_IN_LFFC_Base as EFill_Model
from collections import OrderedDict
import torch.nn.functional as F
from src.model_zoo.basemodel import BaseModel

class EFill_WO_KT_AND_KS(BaseModel):

    def __init__(self,model_path,device, info = {}, targetSize=256,**kwargs):
        super(EFill_WO_KT_AND_KS, self).__init__(**kwargs)
        self.info = info
        ...
        # no Labels.
        print('EFill_WO_KT_AND_KS loaded.')
