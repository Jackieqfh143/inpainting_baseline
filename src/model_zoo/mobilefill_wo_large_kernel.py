...
class MobileFill_WO_LARGE_KERNEL(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/ablations/wo_large_kernel.yaml", **kwargs):
        super(MobileFill_WO_LARGE_KERNEL, self).__init__(**kwargs)
        ...
        # no Labels.
        print('MobileFill_WO_LARGE_KERNEL loaded.')
