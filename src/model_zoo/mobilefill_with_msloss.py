...
class MobileFill_WITH_MSLOSS(BaseModel):

    def __init__(self,model_path, device, info = {},
                 targetSize=256, config_path = "./src/lib/MobileFill/configs/mobilefill.yaml", **kwargs):
        super(MobileFill_WITH_MSLOSS, self).__init__(**kwargs)
        ...
        # no Labels.
        print('MobileFill_WITH_MSLOSS loaded.')
