import torch
from src.lib.EFill.modules.models import DistInpaintModel_SPADE_IN_LFFC_Base_wo_lwgc as EFill_Model
from collections import OrderedDict
import torch.nn.functional as F
from src.model_zoo.basemodel import BaseModel

class EFill_WO_LWGC(BaseModel):

    def __init__(self,model_path,device, info = {}, targetSize=256,**kwargs):
        super(EFill_WO_LWGC, self).__init__(**kwargs)
        self.info = info
