import torch
from src.lib.EFill.modules.EFill_wo_SPADE import DistInpaintModel_LFFC_Base as EFill_Model
from collections import OrderedDict
import torch.nn.functional as F
from src.model_zoo.basemodel import BaseModel

class EFill_WO_SPADE(BaseModel):

    def __init__(self,model_path,device, info = {}, targetSize=256,**kwargs):
        super(EFill_WO_SPADE, self).__init__(**kwargs)
        self.info = info
