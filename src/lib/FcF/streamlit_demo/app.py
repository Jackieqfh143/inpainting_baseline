...
import numpy as np
import torch
from inpainting_baseline.src.libs.FcF.streamlit_demo import legacy
import cv2
...
def create_model(network_pkl):
    ...
    with inpainting_baseline.src.libs.FcF.streamlit_demo.dnnlib.util.open_url(network_pkl) as f:
