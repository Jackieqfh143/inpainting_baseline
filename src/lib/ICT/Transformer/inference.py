...
from ICT.Transformer.models.model import GPTConfig,GPT
import argparse
from ICT.Transformer.utils.util import sample_mask,sample_mask_all
...
if __name__=='__main__':
    ...
    argsDict = {argName: getattr(opts, argName) for argName in vars(opts)}
    import yaml
    with open('ict.yaml', 'w', encoding='utf-8') as f:
