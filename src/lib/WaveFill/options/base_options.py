...
import argparse
import os
from WaveFill.util import util
import torch
import WaveFill.models as models
import WaveFill.data as data
import pickle
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--wavelet_decomp_level', type=int, default=2, help='level of wavelet decomposition')
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='WaveletInpaintLv2GCFRAN', help='selects model to use for netG (pix2pixhd | spade)')
