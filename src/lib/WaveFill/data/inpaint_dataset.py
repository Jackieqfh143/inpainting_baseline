...
from WaveFill.data.base_dataset import BaseDataset, get_transform
...
import WaveFill.util.util as util
import numpy as np
import random
import torch
import os
...
class InpaintDataset(BaseDataset):
    ...
    def load_item(self, index):
        ...
        if self.opt.phase == 'train': 
            ...
            mask = mask.filter(ImageFilter.MaxFilter(3))        #equal to 3x3 maxpooling
