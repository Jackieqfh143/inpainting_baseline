...
from src.lib.WaveFill.models.networks.base_network import BaseNetwork
from src.lib.WaveFill.models.networks.normalization import get_nonspade_norm_layer
from src.lib.WaveFill.models.networks.architecture import ResnetBlock_GC as ResnetBlock_GC
from src.lib.WaveFill.models.networks.architecture import GC_FRANResnetBlock as GC_FRANResnetBlock
from src.lib.WaveFill.models.networks.architecture import GatedConv2dWithActivation as GatedConv2d
from src.lib.WaveFill.models.networks.architecture import Attention as Attention
...
class WaveletInpaintLv2GCFRANGenerator(BaseNetwork):
    ...
    def forward(self, input, z=None):
        ...
        b, c, h, w = input.shape
        # Yh is a list, and list[0] = the first transform result of High frequency(LH, HL and HH )
        Yl, Yh = self.xfm(input) # Yl.shape = [b, c, h//8, w//8]
        Yh1 = Yh[0].contiguous().view(b,c*3,h//2,w//2)  #concatenate in Channel-wise
        ...
        x = self.sp0(x, Yh0)        #Lv2-HighFreq in paper
