...
import src.lib.MISF.kpn.network as network
from src.lib.MISF.kpn.config import get_opt
...
def create_generator(config):
    ...
    generator = network.KPN(color=True, burst_length=1, blind_est=True, kernel_size=[3], sep_conv=False,
                 channel_att=False, spatial_att=False, upMode='bilinear', core_bias=False, filter_type=config.FILTER_TYPE)

    # network.weights_init(generator, init_type='xavier', init_gain=0.02)
