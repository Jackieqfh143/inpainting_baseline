...
from src.lib.MISF.kpn.network import KernelConv
import src.lib.MISF.kpn.utils as kpn_utils
import numpy as np
...
if __name__ == '__main__':
    ...
    config_path = '/home/codeoops/CV/InPainting/Inpainting_baseline/compare/configs/misf.yaml'
    ...
    model = InpaintGenerator(config=opt)
