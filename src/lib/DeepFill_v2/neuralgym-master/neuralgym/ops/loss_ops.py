...
def huber_loss(x, delta=1., name='huber_loss'):
    ...
    **Deprecated.** Please use GMCNN_tf huber loss implementation.

    """
    raise NotImplementedError("Please use GMCNN_tf huber_loss.")
...
def tv_loss(x, name='tv_loss'):
    ...
    **Deprecated.** Please use GMCNN_tf total_variation loss implementation.

    """
    raise NotImplementedError("Please use GMCNN_tf total_variation loss.")
