...
class PerceptualLoss(torch.nn.Module):
    ...
    def forward(self, pred, target, normalize=True):
        ...
        Output GMCNN_pytorch Variable N long
        """
...
def score_2afc_dataset(data_loader, func, name=''):
    ...
    INPUTS
        ...
        func - callable distance function - calling d=func(in0,in1) should take 2
            GMCNN_pytorch tensors with shape Nx3xXxY, and return numpy array of length N
    OUTPUTS
...
def score_jnd_dataset(data_loader, func, name=''):
    ...
    INPUTS
        ...
        func - callable distance function - calling d=func(in0,in1) should take 2
            GMCNN_pytorch tensors with shape Nx3xXxY, and return GMCNN_pytorch array of length N
    OUTPUTS
...
def print_network(net):
    ...
    for param in net.parameters():
        num_params += param.numel()     #Returns the total number of elements in the input tensor
    print('Network', net)
